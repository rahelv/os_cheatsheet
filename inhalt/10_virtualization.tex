...
\begin{description}
    \item[Implementation of Hypervisors]:
        ...
        \item \textbf{Type 2}: applications that run on standard OS (VMM is a P), limited hw feature exploitation. (ex: VirtualBox) %TODO: evt. add comparison picture type 1 & type 2
