...
\begin{description}
    \item[Process] Program loaded into mem, in execution. CPU-bound / I/O bound %NOTE: few&long CPU bursts vs. many & short
...
\end{description}
%TODO: \includegraphics[width=0.5\linewidth]{process_state.png}
...
\begin{description}
  ...
  % \item[Remote Procedure Calls]abstract procedure calls between Ps on networked systems. Stubs (client-side proxy for procedure on server)
  %TODO: RPC's
\end{description}
